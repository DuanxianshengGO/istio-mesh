<template>
  <layout-content :header="$t('business.istio.edit_virtualservice')" :back-to="{name: 'VirtualServices', query: $route.query}">
...
import { getVirtualService, updateVirtualService } from "@/api/istio"
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      updateVirtualService(this.cluster, this.namespace, this.name, data)
        .then(() => {
          this.$message({
            type: "success",
