...
const message = {
  ...
  business: {
    ...
    istio: {
      mesh: "服务网格",
      virtualservice: "虚拟服务",
      virtualservice_list: "虚拟服务列表",
      create_virtualservice: "创建虚拟服务",
      edit_virtualservice: "编辑虚拟服务",
      virtualservice_detail: "虚拟服务详情",
      destinationrule: "目标规则",
      destinationrule_list: "目标规则列表",
      create_destinationrule: "创建目标规则",
      edit_destinationrule: "编辑目标规则",
      destinationrule_detail: "目标规则详情",
      gateway: "网关",
      gateway_list: "网关列表",
      create_gateway: "创建网关",
      edit_gateway: "编辑网关",
      ...
      traffic_rule: "流量规则",
      filter: "过滤器",
      virtual_services: "虚拟服务",
      destination_rules: "目标规则",
      traffic_routes: "流量路由",
      traffic_flow: "流量流向",
      traffic_flow_chart_placeholder: "流量流向图（开发中）",
      service_traffic_details: "服务流量详情",
      pod_traffic: "Pod 流量",
      subset: "子集",
      total_pods: "总Pod数",
      basic_traffic: "基础流量",
      ...
      match_headers: "匹配请求头",
      match_content: "匹配内容",
      basic_subsets: "基础路由子集",
      gray_subsets: "灰度路由子集",
      yaml_content: "YAML内容",
      yaml_create: "YAML创建",
      load_template: "加载模板",
      validate_yaml: "验证YAML",
      yaml_placeholder: "请输入YAML配置内容...",
      add_subset: "添加子集",
      ports: "端口",
      port: "端口",
      selector: "选择器",
