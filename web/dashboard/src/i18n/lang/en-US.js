...
service_whole_domain: "Service whole domain",
    ...
    istio: {
      ...
      virtualservice_list: "Virtual Service List",
      create_virtualservice: "Create Virtual Service",
      edit_virtualservice: "Edit Virtual Service",
      virtualservice_detail: "Virtual Service Detail",
      destinationrule: "Destination Rule",
      destinationrule_list: "Destination Rule List",
      create_destinationrule: "Create Destination Rule",
      edit_destinationrule: "Edit Destination Rule",
      destinationrule_detail: "Destination Rule Detail",
      gateway: "Gateway",
      ...
      destination_subset: "Destination Subset",
      weight: "Weight",
      ...
      traffic_routes: "Traffic Routes",
      traffic_flow: "Traffic Flow",
      traffic_flow_chart_placeholder: "Traffic Flow Chart (Under Development)",
      service_traffic_details: "Service Traffic Details",
      pod_traffic: "Pod Traffic",
      subset: "Subset",
      ...
      rule: {
        hosts: "Please enter hosts list",
        host: "Please enter host name"
      }
    },
    common: {
      label: "Label",
